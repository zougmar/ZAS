        ...
        <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
          <div>
            ...
            <p className="mt-1 text-sm text-gray-500 sm:text-base">
              Manage teaching staff and specializations
            </p>
          </div>
          <button
            onClick={() => {
              ...
              <table className="min-w-full divide-y divide-gray-200">
                <thead>
                  <tr className="bg-gray-50/50">
                    ...
                    <th className="px-3 py-3.5 text-left text-xs font-semibold uppercase tracking-wider text-gray-600">Specialization</th>
                ...
                <tbody className="divide-y divide-gray-200 bg-white">
                  {filteredTeachers.length === 0 ? (
                    <tr>
                      <td colSpan="5" className="py-16 text-center">
                        <div className="mx-auto flex max-w-sm flex-col items-center">
                          ...
                          <p className="mt-3 text-sm font-medium text-gray-900">No teachers found</p>
                    ...
                    filteredTeachers.map((teacher) => (
                      <tr key={teacher._id} className="transition hover:bg-gray-50/80">
                        <td className="whitespace-nowrap py-4 pl-4 pr-3 sm:pl-6">
                          <span className="font-medium text-gray-900">{teacher.user.name}</span>
                        </td>
                        <td className="whitespace-nowrap px-3 py-4 text-sm text-gray-600">{teacher.user.email}</td>
                        <td className="whitespace-nowrap px-3 py-4 text-sm text-gray-600">{teacher.phone || '—'}</td>
                        <td className="whitespace-nowrap px-3 py-4 text-sm text-gray-600">{teacher.specialization || '—'}</td>
