...
import { User, Mail, Shield, Edit2, X, Check, ImageIcon } from 'lucide-react';
...
const AdminProfile = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (!userId) return;
    try {
      const payload = { name: formData.name, email: formData.email, photo: formData.photo || '' };
    ...
    <Layout>
      <div className="space-y-8">
        ...
        <div className="overflow-hidden rounded-xl border border-gray-200 bg-white shadow-sm">
          ...
          <div className="p-6">
            {editing ? (
              <form id="admin-profile-form" onSubmit={handleSubmit} className="max-w-md space-y-4">
                <div>
              ...
              <dl className="grid gap-4 sm:grid-cols-1">
                <div className="flex items-center gap-3 rounded-lg border border-gray-100 bg-gray-50/50 px-4 py-3">
                  ...
                  <div>
                    ...
                    <dd className="mt-0.5 font-medium text-gray-900">{profile?.name}</dd>
                  </div>
                </div>
                <div className="flex items-center gap-3 rounded-lg border border-gray-100 bg-gray-50/50 px-4 py-3">
                  ...
                  <div>
                    ...
                    <dd className="mt-0.5 font-medium text-gray-900">{profile?.email}</dd>
                  </div>
                </div>
                <div className="flex items-center gap-3 rounded-lg border border-gray-100 bg-gray-50/50 px-4 py-3">
                  ...
                  <div>
                    ...
                    <dd className="mt-0.5 font-medium text-gray-900 capitalize">{profile?.role}</dd>
                  </div>
                </div>
              </dl>
            )}
